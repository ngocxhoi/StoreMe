<template>
  <NuxtLink
    to="/dashboard"
    class="flex items-center justify-center rounded-xl shadow-lg dark:shadow-gray-700 cursor-pointer"
  >
    <div
      class="flex items-center justify-center overflow-hidden"
      :class="size ?? 'size-20'"
    >
      <svg viewBox="0 0 350 100" class="scale-[2]">
        <g
          id="SvgjsG1209"
          featurekey="ghXSps-0"
          transform="matrix(1.555550940256508,0,0,1.555550940256508,97.22199458907991,-19.026674827268902)"
          fill="#CF4D2E"
        >
          <path
    ...
    <span
      v-if="fullLogo"
      class="text-red-500 text-3xl font-semibold hidden lg:block"
      >StoreMe</span
    >
  </NuxtLink>
</template>
